...
class NutAssembly(SingleArmEnv):
    ...
    def staged_rewards(self):
        ...
        # reaching goal reward for putting the nut on the goal (peg)
    ...
    def _load_model(self):
        ...
        if self.placement_initializer is None:
            ...
            for nut_name, default_y_range in zip(nut_names, ([0.1, 0.2], [-0.2, -0.1])):
    ...
    def _reset_internal(self):
        ...
        self.goal_pos = np.array([0.1, -0.1, 0.85])
    ...
    def _check_success(self):
        ...
        if self.single_object_mode == 2 and self.nut_id == 1:
            ...
            dist_goal_to_peg_z = np.abs(self.goal_pos[2] - nut_pos[2])
            goal_peg_same_height = dist_goal_to_peg_z < 0.05

        return nut_fit_peg and goal_peg_same_height
